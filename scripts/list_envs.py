...
All the environments are registered in the `roombah` extension. They start
...
import roombah.tasks  # noqa: F401


def main():
    """Print all environments registered in `roombah` extension."""
